...
function ClipboardLinkButtons(props) {
  ...
  return /* @__PURE__ */ React.createElement("div", null, "This content", /* @__PURE__ */ React.createElement(CopyToClipboard, {
    onCopy: () => addToast("Link copied to clipboard!", ToastType.SUCCESS),
    text: link
...
function VersionHistoryPanel(props) {
  ...
  for (let version of versionHistory.contents.named) {
    let releaseButton = /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("button", {
      onClick: (e) => toggleReleaseNamed(props.branchId, version.versionId)
    }, "Release"));
    let releasedIcon = "";
    if (version.isReleased === "1") {
      releaseButton = /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("button", {
        onClick: (e) => toggleReleaseNamed(props.branchId, version.versionId)
      }, "Retract"));
      releasedIcon = "•";
    }
    let namedTitle = `${releasedIcon} ${version.title}`;
    namedVersions.push(/* @__PURE__ */ React.createElement(CollapseSection, {
      title: namedTitle,
      collapsed: true,
      widthCSS: "200px"
    }, /* @__PURE__ */ React.createElement(ClipboardLinkButtons, {
      ...
      onClick: (e) => versionHistoryActive(version)
    }, "View")), /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("button", {
      onClick: (e) => console.log(">>>Set As Current " + version.versionId)
  ...
  const namedSection = /* @__PURE__ */ React.createElement(CollapseSection, {
    title: namedVersionsTitle,
    collapsed: false
  }, namedVersions);
  let saveSection = [];
  for (let version of versionHistory.contents.autoSaves) {
    saveSection.push(/* @__PURE__ */ React.createElement(CollapseSection, {
  ...
  let autoSaves = /* @__PURE__ */ React.createElement(CollapseSection, {
    title: autoSaveTitle,
    collapsed: true
  }, saveSection);
  return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(CollapseSection, {
    title: "Current Version",
    collapsed: true
  }, "buttons"), namedSection, autoSaves);
}
